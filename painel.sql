...
--
-- Host: 127.0.0.1
-- Generation Time: 29-Mar-2017 às 19:37
...
--
-- Estrutura da tabela `tb_galleries`
--

CREATE TABLE `tb_galleries` (
  `gallery_cod` int(11) NOT NULL,
  `gallery_name` varchar(250) NOT NULL,
  `gallery_text` text
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Extraindo dados da tabela `tb_galleries`
--

INSERT INTO `tb_galleries` (`gallery_cod`, `gallery_name`, `gallery_text`) VALUES
(1, 'Galeria teste 1', 'Texto galeria texto galeria texto galeria texto galeria texto galeria texto galeria texto galeria texto galeria texto galeria texto galeria.'),
(2, 'Galeria teste 2', 'Texto galeria texto galeria texto galeria texto galeria texto galeria texto galeria texto galeria texto galeria texto galeria texto galeria.'),
(3, 'Galeria teste 1', 'Texto galeria texto galeria texto galeria texto galeria texto galeria texto galeria texto galeria texto galeria texto galeria texto galeria.'),
(4, 'Galeria teste 2', 'Texto galeria texto galeria texto galeria texto galeria texto galeria texto galeria texto galeria texto galeria texto galeria texto galeria.'),
(5, 'Galeria Cadastrada', 'Texto teste texto teste texto teste texto teste texto teste texto teste texto teste texto teste.');
...
--
-- Extraindo dados da tabela `tb_images`
--

INSERT INTO `tb_images` (`image_cod`, `image_gallery`, `image_name`, `image_date`, `image_link`, `image_text`) VALUES
(1, 5, 'foto1.jpg', NULL, NULL, NULL),
(2, 5, 'foto2.jpg', NULL, NULL, NULL),
(3, 5, 'foto3.jpg', NULL, NULL, NULL),
(4, 5, 'foto4.jpg', NULL, NULL, NULL);
...
ALTER TABLE `tb_galleries`
  ADD PRIMARY KEY (`gallery_cod`);

--
-- Indexes for table `tb_images`
--
ALTER TABLE `tb_images`
  ADD PRIMARY KEY (`image_cod`);
...
--
ALTER TABLE `tb_galleries`
  MODIFY `gallery_cod` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `tb_images`
--
ALTER TABLE `tb_images`
  MODIFY `image_cod` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
