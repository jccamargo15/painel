...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
	...
	<!-- form to register clients that action calls download_insert.php file -->
	<form class="form-horizontal" name="file_send" action="?page=download_insert" method="post" enctype="multipart/form-data">
		<fieldset>
